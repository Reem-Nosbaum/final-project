...
class AdministratorFacade(FacadeBase):
	...
	def add_customer(self, customer, user, token):
		...
		if self.repo.get_by_id(Users, user.id) is not None:
	...
	def remove_airline(self, airline_id, token):
		...
		deleted_airline_id = airline1.user_id
		...
		self.repo.delete_by_id(Users, Users.id, deleted_airline_id)
